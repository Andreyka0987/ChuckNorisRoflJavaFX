package org.example.demos1234.telegram;
...
public class TelegramBot extends TelegramLongPollingBot implements TelegramModel {
...
//        }
    ...
    public void sendMessage(long chatId, String message) {
        ...
        String messageText = "Привіт із JavaFX!";

        try {
            String encodedMessage = URLEncoder.encode(message, "UTF-8");

            String urlString = "https://api.telegram.org/bot" + key +
